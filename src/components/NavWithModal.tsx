    ...
    <nav className="sticky top-0 z-50 bg-brand-black text-white border-b-2 border-brand-black">
      <div className="flex items-center justify-between px-10 max-md:px-6 h-12">
        ...
        <div className="flex items-center gap-6">
          <Link href="/#track-record" className="bg-brand-red-orange text-white text-xs font-mono uppercase tracking-wide px-4 py-2 hover:opacity-90 transition-opacity">
            Get access
          </Link>
        </div>
      </div>
